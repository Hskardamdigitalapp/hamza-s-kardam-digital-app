...
class _CustomerCareButtonState extends State<CustomerCareButton> {
  ...
  Widget build(BuildContext context) {
    ...
    return Positioned(right: 16, bottom: bottom + 16, child: Semantics(button: true, label: 'Customer care', child: AnimatedOpacity(duration: const Duration(milliseconds: 220), opacity: _dimmed ? .38 : 1, child: Material(color: Colors.transparent, elevation: 10, shadowColor: _gold.withOpacity(.45), borderRadius: BorderRadius.circular(18), child: InkWell(onTap: _openCustomerCare, borderRadius: BorderRadius.circular(18), child: Container(width: 62, height: 62, decoration: BoxDecoration(color: _gold, borderRadius: BorderRadius.circular(18), border: Border.all(color: Colors.white.withOpacity(.75), width: 1.2)), child: const Icon(Icons.support_agent_rounded, color: _navy, size: 34))))));
  }
}
