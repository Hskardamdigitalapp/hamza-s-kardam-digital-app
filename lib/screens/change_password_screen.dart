...
class _ChangePasswordScreenState extends State<ChangePasswordScreen> {
  ...
  Future<void> _update() async {
    ...
    if (email == null || email.isEmpty) {
      _show('Please sign in again.');
      return;
    }

    if (_current.text.isEmpty || !_lengthOk || !_different || !_match) {
      _show('Please complete all password requirements.');
      return;
    }
    ...
    try {
      ...
      await Supabase.instance.client.auth.updateUser(
        UserAttributes(password: _new.text),
      );
      ...
      if (mounted) {
        _show(e.message.isNotEmpty ? e.message : 'Unable to update password.');
      }
    } catch (_) {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              color: dark ? const Color(0xFF17191E) : Colors.white,
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    disabledBackgroundColor: _gold.withValues(alpha: .55),
  ...
  Widget _field(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        filled: true,
        fillColor: Theme.of(context).brightness == Brightness.dark ? _darkCard : Colors.white,
        ...
        children: [
          ...
          Expanded(
            child: Text(
              text,
              style: TextStyle(
                color: ok ? Theme.of(context).textTheme.bodyMedium?.color : hint,
