  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.fromLTRB(28, 18, 28, 40), children: [
        ...
        _serviceCard(context, Icons.mosque_rounded, 'Hajj / Umrah', 'Book your pilgrimage with a trusted travel partner — packages, flights & visa.', 'bilalsadasubtravels.com', () => _open('https://bilalsadastravels.com')),
