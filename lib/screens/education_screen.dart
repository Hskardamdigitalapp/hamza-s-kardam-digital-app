  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: ListView(padding: const EdgeInsets.all(22), children: [
      ...
      Container(
        ...
        child: Text(
          exam == 'WAEC' ? 'WAEC is the currently documented VTpass education product.' : 'This option is displayed, but its provider catalogue is not yet connected.',
  ...
  Widget _examCard(String name, String logo) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(children: [
          Container(width: 58, height: 58, color: Colors.white, child: Image.network(logo, fit: BoxFit.contain, errorBuilder: (context, error, stack) => Center(child: Text(name.substring(0, 1), style: const TextStyle(color: Colors.black, fontWeight: FontWeight.w900, fontSize: 22))))),
