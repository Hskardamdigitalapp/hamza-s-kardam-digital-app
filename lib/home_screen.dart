...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _soon(String service) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(content: Text('$service is coming soon.')),
    );
  }

  Future<void> _whatsapp([
    String message = 'Hello H.salah Communication, I need help with your digital services.',
  ]) async {
    final uri = Uri.parse(
          ...
          Row(
            children: [
              ...
              TextButton(
                ...
                child: Text(_showAllServices ? 'Show less' : 'View all', style: const TextStyle(color: _gold, fontWeight: FontWeight.bold)),
              ),
            ],
          ),
          GridView.builder(
          ...
          Column(
            children: [
              Container(
                ...
                height: 58,
                decoration: BoxDecoration(
                  color: _navy.withValues(alpha: .055),
              ...
              Expanded(
                child: Text(
                  ...
                  style: const TextStyle(color: _navy, fontWeight: FontWeight.w700, fontSize: 12, height: 1.1),
                ),
              ),
            ],
          ),
          if (service.hot)
            Positioned(
              ...
              child: Container(
                ...
                child: const Text('HOT', style: TextStyle(color: _navy, fontWeight: FontWeight.w900, fontSize: 8)),
              ),
            ),
        ],
      ),
          ...
          children: [
            ...
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Buy on WhatsApp', style: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w900)),
                  Text('Data, airtime, SIMs & digital services — chat with us', style: TextStyle(color: Colors.white70, fontSize: 12)),
                ],
              ),
            ),
          ...
          children: [
            const Padding(
              ...
              child: Align(
                ...
                child: Text('Wallet actions', style: TextStyle(color: _navy, fontSize: 20, fontWeight: FontWeight.w900)),
              ),
            ),
  ...
  void _showSimDialog() {
    showDialog<void>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text(
          'We sell MTN, Airtel, T2 and Glo SIM cards, and we also provide MTN ↔ Airtel SIM swap service.\n\nFor availability, price and home service, chat with us on WhatsApp.',
        ),
        actions: [
          ...
          ElevatedButton.icon(
            onPressed: () {
              Navigator.pop(context);
              _whatsapp('Hello H.salah Communication, I want to buy a SIM / request an MTN or Airtel SIM swap.');
            },
            icon: const Icon(Icons.chat),
