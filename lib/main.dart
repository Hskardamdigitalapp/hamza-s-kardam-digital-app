  ...
  Future<bool> _confirmExit() async {
    ...
    return await showDialog<bool>(
      ...
      builder: (c) => AlertDialog(
        backgroundColor: const Color(0xFF0A2C68),
        ...
        content: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          const Text('Are you sure you want to exit?', textAlign: TextAlign.center, style: TextStyle(color: Color(0xFFB7C2D6), fontSize: 18, fontWeight: FontWeight.w600)),
